...
JS
    ...
    assert_contains "$extracted/.vite/build/main-test.js" 'async waitForReady(){if(typeof this.tray.whenReady!=`function`)return!0'
    assert_contains "$extracted/.vite/build/main-test.js" 'isReady(){return typeof this.tray.isReady==`function`?this.tray.isReady():!0}'
...
NODE
    ...
    assert_occurrence_count "$extracted/.vite/build/main-test.js" 'async waitForReady(){if(typeof this.tray.whenReady!=`function`)return!0' '1'
    assert_occurrence_count "$extracted/.vite/build/main-test.js" 'isReady(){return typeof this.tray.isReady==`function`?this.tray.isReady():!0}' '1'
