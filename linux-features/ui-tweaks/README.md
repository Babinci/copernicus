...
| `sidebar.threadColor` | `patches/sidebar-thread-color.js` | Adds a named color submenu to every local sidebar chat, displaying the saved color as a soft full-row tint. | `tweaks.sidebar.threadColor.enabled` |
